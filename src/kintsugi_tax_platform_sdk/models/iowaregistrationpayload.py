...
IowaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "IowaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


IowaRegistrationPayloadAmountFees = TypeAliasType(
    "IowaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class IowaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Iowa registration import."""
    ...
    jurisdiction_specific_fields: IowaFieldsTypedDict
    r"""State-specific fields for Iowa Department of Revenue registration import."""
    ...
    amount_fees: NotRequired[IowaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class IowaRegistrationPayload(BaseModel):
    r"""Full payload for Iowa registration import."""
    ...
    jurisdiction_specific_fields: IowaFields
    r"""State-specific fields for Iowa Department of Revenue registration import."""
    ...
    amount_fees: Optional[IowaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    IowaRegistrationPayload.model_rebuild()
except NameError:
    pass
