...
HawaiiRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "HawaiiRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


HawaiiRegistrationPayloadAmountFees = TypeAliasType(
    "HawaiiRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class HawaiiRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Hawaii Revenue Online registration import"""
    ...
    jurisdiction_specific_fields: HawaiiFieldsTypedDict
    ...
    amount_fees: NotRequired[HawaiiRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class HawaiiRegistrationPayload(BaseModel):
    r"""Full payload for Hawaii Revenue Online registration import"""
    ...
    jurisdiction_specific_fields: HawaiiFields
    r"""State-specific fields for Hawaii Revenue Online registration import."""
    ...
    amount_fees: Optional[HawaiiRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    HawaiiRegistrationPayload.model_rebuild()
except NameError:
    pass
