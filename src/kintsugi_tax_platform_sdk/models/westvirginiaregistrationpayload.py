...
WestVirginiaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "WestVirginiaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


WestVirginiaRegistrationPayloadAmountFees = TypeAliasType(
    "WestVirginiaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class WestVirginiaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for West Virginia registration import."""
    ...
    jurisdiction_specific_fields: WestVirginiaFieldsTypedDict
    ...
    amount_fees: NotRequired[WestVirginiaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class WestVirginiaRegistrationPayload(BaseModel):
    r"""Full payload for West Virginia registration import."""
    ...
    jurisdiction_specific_fields: WestVirginiaFields
    r"""State-specific fields for West Virginia MyTaxes portal registration import."""
    ...
    amount_fees: Optional[WestVirginiaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    WestVirginiaRegistrationPayload.model_rebuild()
except NameError:
    pass
