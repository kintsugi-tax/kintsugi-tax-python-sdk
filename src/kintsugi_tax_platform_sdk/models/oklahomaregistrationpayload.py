...
from .oklahomafields import OklahomaFields, OklahomaFieldsTypedDict
...
OklahomaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "OklahomaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


OklahomaRegistrationPayloadAmountFees = TypeAliasType(
    "OklahomaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class OklahomaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Oklahoma registration import."""
    ...
    jurisdiction_specific_fields: OklahomaFieldsTypedDict
    ...
    amount_fees: NotRequired[OklahomaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class OklahomaRegistrationPayload(BaseModel):
    r"""Full payload for Oklahoma registration import."""
    ...
    jurisdiction_specific_fields: OklahomaFields
    r"""State-specific fields for Oklahoma OkTAP portal registration import."""
    ...
    amount_fees: Optional[OklahomaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    OklahomaRegistrationPayload.model_rebuild()
except NameError:
    pass
