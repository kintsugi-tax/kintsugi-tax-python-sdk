...
AlabamaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "AlabamaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


AlabamaRegistrationPayloadAmountFees = TypeAliasType(
    "AlabamaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class AlabamaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Alabama registration import.
    ...
    jurisdiction_specific_fields: AlabamaFieldsTypedDict
    ...
    amount_fees: NotRequired[AlabamaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class AlabamaRegistrationPayload(BaseModel):
    r"""Full payload for Alabama registration import.
    Nests Alabama-specific fields under jurisdiction_specific_fields.
    Participates in the discriminated union for route-level validation
    via Tag(\"REGULAR_US_AL\").
    ...
    jurisdiction_specific_fields: AlabamaFields
    r"""State-specific fields for Alabama registration import.
    ...
    amount_fees: Optional[AlabamaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    AlabamaRegistrationPayload.model_rebuild()
except NameError:
    pass
