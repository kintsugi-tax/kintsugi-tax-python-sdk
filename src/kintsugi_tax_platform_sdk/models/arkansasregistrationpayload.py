...
ArkansasRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "ArkansasRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


ArkansasRegistrationPayloadAmountFees = TypeAliasType(
    "ArkansasRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class ArkansasRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Arkansas registration import."""
    ...
    jurisdiction_specific_fields: ArkansasFieldsTypedDict
    ...
    amount_fees: NotRequired[ArkansasRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class ArkansasRegistrationPayload(BaseModel):
    r"""Full payload for Arkansas registration import."""
    ...
    jurisdiction_specific_fields: ArkansasFields
    r"""State-specific fields for Arkansas registration import (ATAP).
    ...
    amount_fees: Optional[ArkansasRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    ArkansasRegistrationPayload.model_rebuild()
except NameError:
    pass
