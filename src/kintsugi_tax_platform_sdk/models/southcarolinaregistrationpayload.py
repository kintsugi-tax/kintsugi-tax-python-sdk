...
SouthCarolinaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "SouthCarolinaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


SouthCarolinaRegistrationPayloadAmountFees = TypeAliasType(
    "SouthCarolinaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class SouthCarolinaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for South Carolina registration import."""
    ...
    jurisdiction_specific_fields: SouthCarolinaFieldsTypedDict
    ...
    amount_fees: NotRequired[SouthCarolinaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class SouthCarolinaRegistrationPayload(BaseModel):
    r"""Full payload for South Carolina registration import."""
    ...
    jurisdiction_specific_fields: SouthCarolinaFields
    r"""State-specific fields for South Carolina (MyDORWAY) registration import."""
    ...
    amount_fees: Optional[SouthCarolinaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    SouthCarolinaRegistrationPayload.model_rebuild()
except NameError:
    pass
