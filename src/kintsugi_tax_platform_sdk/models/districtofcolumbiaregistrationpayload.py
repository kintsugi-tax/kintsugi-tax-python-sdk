...
DistrictOfColumbiaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "DistrictOfColumbiaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


DistrictOfColumbiaRegistrationPayloadAmountFees = TypeAliasType(
    "DistrictOfColumbiaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class DistrictOfColumbiaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for District of Columbia registration import."""
    ...
    jurisdiction_specific_fields: DistrictOfColumbiaFieldsTypedDict
    ...
    amount_fees: NotRequired[DistrictOfColumbiaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class DistrictOfColumbiaRegistrationPayload(BaseModel):
    r"""Full payload for District of Columbia registration import."""
    ...
    jurisdiction_specific_fields: DistrictOfColumbiaFields
    r"""State-specific fields for District of Columbia MyTax.DC portal registration import."""
    ...
    amount_fees: Optional[DistrictOfColumbiaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    DistrictOfColumbiaRegistrationPayload.model_rebuild()
except NameError:
    pass
