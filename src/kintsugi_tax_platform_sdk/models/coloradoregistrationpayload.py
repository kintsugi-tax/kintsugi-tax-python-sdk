...
ColoradoRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "ColoradoRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


ColoradoRegistrationPayloadAmountFees = TypeAliasType(
    "ColoradoRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class ColoradoRegistrationPayloadTypedDict(TypedDict):
    r"""Create/import payload for Colorado, including RDF obligation declaration."""
    ...
    amount_fees: NotRequired[ColoradoRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
    ...
    r"""Whether this Colorado registration is declared obligated to file a Retail Delivery Fee return (DR 1786)."""


class ColoradoRegistrationPayload(BaseModel):
    r"""Create/import payload for Colorado, including RDF obligation declaration."""
    ...
    amount_fees: Optional[ColoradoRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    ColoradoRegistrationPayload.model_rebuild()
except NameError:
    pass
