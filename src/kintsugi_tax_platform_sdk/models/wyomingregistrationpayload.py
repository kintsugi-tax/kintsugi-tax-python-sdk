...
WyomingRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "WyomingRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


WyomingRegistrationPayloadAmountFees = TypeAliasType(
    "WyomingRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class WyomingRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Wyoming registration import."""
    ...
    jurisdiction_specific_fields: WyomingFieldsTypedDict
    ...
    amount_fees: NotRequired[WyomingRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
    ...
    r"""Optional PIN for WYPath. Encrypted into pin_encrypted on save."""


class WyomingRegistrationPayload(BaseModel):
    r"""Full payload for Wyoming registration import."""
    ...
    jurisdiction_specific_fields: WyomingFields
    r"""State-specific fields for Wyoming (WYPath) registration import.
    ...
    amount_fees: Optional[WyomingRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    WyomingRegistrationPayload.model_rebuild()
except NameError:
    pass
