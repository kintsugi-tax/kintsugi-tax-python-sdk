...
MissouriRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MissouriRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MissouriRegistrationPayloadAmountFees = TypeAliasType(
    "MissouriRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MissouriRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Missouri registration import."""
    ...
    jurisdiction_specific_fields: MissouriFieldsTypedDict
    ...
    amount_fees: NotRequired[MissouriRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MissouriRegistrationPayload(BaseModel):
    r"""Full payload for Missouri registration import."""
    ...
    jurisdiction_specific_fields: MissouriFields
    r"""State-specific fields for Missouri portal registration import (MyTax Missouri)."""
    ...
    amount_fees: Optional[MissouriRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MissouriRegistrationPayload.model_rebuild()
except NameError:
    pass
