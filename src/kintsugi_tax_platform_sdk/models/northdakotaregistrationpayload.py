...
NorthDakotaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NorthDakotaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NorthDakotaRegistrationPayloadAmountFees = TypeAliasType(
    "NorthDakotaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NorthDakotaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for North Dakota registration import."""
    ...
    jurisdiction_specific_fields: NorthDakotaFieldsTypedDict
    ...
    amount_fees: NotRequired[NorthDakotaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class NorthDakotaRegistrationPayload(BaseModel):
    r"""Full payload for North Dakota registration import."""
    ...
    jurisdiction_specific_fields: NorthDakotaFields
    r"""State-specific fields for North Dakota tax portal registration import."""
    ...
    amount_fees: Optional[NorthDakotaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NorthDakotaRegistrationPayload.model_rebuild()
except NameError:
    pass
