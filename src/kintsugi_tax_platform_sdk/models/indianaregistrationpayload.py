...
IndianaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "IndianaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


IndianaRegistrationPayloadAmountFees = TypeAliasType(
    "IndianaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class IndianaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Indiana registration import."""
    ...
    jurisdiction_specific_fields: IndianaFieldsTypedDict
    ...
    amount_fees: NotRequired[IndianaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class IndianaRegistrationPayload(BaseModel):
    r"""Full payload for Indiana registration import."""
    ...
    jurisdiction_specific_fields: IndianaFields
    r"""State-specific fields for Indiana INTIME portal registration import."""
    ...
    amount_fees: Optional[IndianaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    IndianaRegistrationPayload.model_rebuild()
except NameError:
    pass
