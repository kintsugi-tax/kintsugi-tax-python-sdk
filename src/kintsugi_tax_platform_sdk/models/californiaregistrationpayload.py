...
CaliforniaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "CaliforniaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


CaliforniaRegistrationPayloadAmountFees = TypeAliasType(
    "CaliforniaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class CaliforniaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for California registration import."""
    ...
    jurisdiction_specific_fields: CaliforniaFieldsTypedDict
    ...
    amount_fees: NotRequired[CaliforniaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class CaliforniaRegistrationPayload(BaseModel):
    r"""Full payload for California registration import."""
    ...
    jurisdiction_specific_fields: CaliforniaFields
    r"""State-specific fields for California CDTFA portal registration import."""
    ...
    amount_fees: Optional[CaliforniaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    CaliforniaRegistrationPayload.model_rebuild()
except NameError:
    pass
