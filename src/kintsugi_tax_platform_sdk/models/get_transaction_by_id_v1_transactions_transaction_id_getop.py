...
class GetTransactionByIDV1TransactionsTransactionIDGetRequestTypedDict(TypedDict):
    transaction_id: str
    r"""The unique identifier of the transaction to retrieve."""
    x_organization_id: Nullable[str]
    r"""The unique identifier for the organization making the request"""


class GetTransactionByIDV1TransactionsTransactionIDGetRequest(BaseModel):
