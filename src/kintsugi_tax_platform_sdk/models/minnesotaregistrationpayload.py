...
MinnesotaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MinnesotaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MinnesotaRegistrationPayloadAmountFees = TypeAliasType(
    "MinnesotaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MinnesotaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Minnesota registration import."""
    ...
    jurisdiction_specific_fields: MinnesotaFieldsTypedDict
    ...
    amount_fees: NotRequired[MinnesotaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MinnesotaRegistrationPayload(BaseModel):
    r"""Full payload for Minnesota registration import."""
    ...
    jurisdiction_specific_fields: MinnesotaFields
    r"""State-specific fields for Minnesota e-Services registration import."""
    ...
    amount_fees: Optional[MinnesotaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MinnesotaRegistrationPayload.model_rebuild()
except NameError:
    pass
