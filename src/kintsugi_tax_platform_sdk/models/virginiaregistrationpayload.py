...
VirginiaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "VirginiaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


VirginiaRegistrationPayloadAmountFees = TypeAliasType(
    "VirginiaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class VirginiaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Virginia registration import."""
    ...
    jurisdiction_specific_fields: VirginiaFieldsTypedDict
    ...
    amount_fees: NotRequired[VirginiaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class VirginiaRegistrationPayload(BaseModel):
    r"""Full payload for Virginia registration import."""
    ...
    jurisdiction_specific_fields: VirginiaFields
    r"""State-specific fields for Virginia tax portal registration import."""
    ...
    amount_fees: Optional[VirginiaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    VirginiaRegistrationPayload.model_rebuild()
except NameError:
    pass
