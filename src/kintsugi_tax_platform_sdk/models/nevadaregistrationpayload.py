...
NevadaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NevadaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NevadaRegistrationPayloadAmountFees = TypeAliasType(
    "NevadaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NevadaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Nevada registration import."""
    ...
    jurisdiction_specific_fields: NevadaFieldsTypedDict
    ...
    amount_fees: NotRequired[NevadaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class NevadaRegistrationPayload(BaseModel):
    r"""Full payload for Nevada registration import."""
    ...
    jurisdiction_specific_fields: NevadaFields
    r"""State-specific fields for Nevada (My Nevada Tax) registration import."""
    ...
    amount_fees: Optional[NevadaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NevadaRegistrationPayload.model_rebuild()
except NameError:
    pass
