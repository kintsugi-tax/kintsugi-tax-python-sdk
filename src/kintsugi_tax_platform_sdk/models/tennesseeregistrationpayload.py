...
TennesseeRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "TennesseeRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


TennesseeRegistrationPayloadAmountFees = TypeAliasType(
    "TennesseeRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class TennesseeRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Tennessee TNTAP registration import."""
    ...
    jurisdiction_specific_fields: TennesseeFieldsTypedDict
    ...
    amount_fees: NotRequired[TennesseeRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class TennesseeRegistrationPayload(BaseModel):
    r"""Full payload for Tennessee TNTAP registration import."""
    ...
    jurisdiction_specific_fields: TennesseeFields
    r"""State-specific fields for Tennessee TNTAP portal registration import."""
    ...
    amount_fees: Optional[TennesseeRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    TennesseeRegistrationPayload.model_rebuild()
except NameError:
    pass
