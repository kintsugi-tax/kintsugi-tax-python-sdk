...
WashingtonRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "WashingtonRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


WashingtonRegistrationPayloadAmountFees = TypeAliasType(
    "WashingtonRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class WashingtonRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Washington registration import."""
    ...
    jurisdiction_specific_fields: WashingtonFieldsTypedDict
    ...
    amount_fees: NotRequired[WashingtonRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class WashingtonRegistrationPayload(BaseModel):
    r"""Full payload for Washington registration import."""
    ...
    jurisdiction_specific_fields: WashingtonFields
    r"""State-specific fields for Washington MyDOR portal registration import."""
    ...
    amount_fees: Optional[WashingtonRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    WashingtonRegistrationPayload.model_rebuild()
except NameError:
    pass
