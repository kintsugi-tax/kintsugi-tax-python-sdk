...
PennsylvaniaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "PennsylvaniaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


PennsylvaniaRegistrationPayloadAmountFees = TypeAliasType(
    "PennsylvaniaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class PennsylvaniaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Pennsylvania registration import."""
    ...
    jurisdiction_specific_fields: PennsylvaniaFieldsTypedDict
    ...
    amount_fees: NotRequired[PennsylvaniaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class PennsylvaniaRegistrationPayload(BaseModel):
    r"""Full payload for Pennsylvania registration import."""
    ...
    jurisdiction_specific_fields: PennsylvaniaFields
    r"""State-specific fields for Pennsylvania myPATH registration import."""
    ...
    amount_fees: Optional[PennsylvaniaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    PennsylvaniaRegistrationPayload.model_rebuild()
except NameError:
    pass
