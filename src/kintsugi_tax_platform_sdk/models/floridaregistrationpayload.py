...
FloridaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "FloridaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


FloridaRegistrationPayloadAmountFees = TypeAliasType(
    "FloridaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class FloridaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Florida registration import."""
    ...
    jurisdiction_specific_fields: FloridaFieldsTypedDict
    ...
    amount_fees: NotRequired[FloridaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class FloridaRegistrationPayload(BaseModel):
    r"""Full payload for Florida registration import."""
    ...
    jurisdiction_specific_fields: FloridaFields
    r"""State-specific fields for Florida (eFile & Pay) registration import.
    ...
    amount_fees: Optional[FloridaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    FloridaRegistrationPayload.model_rebuild()
except NameError:
    pass
