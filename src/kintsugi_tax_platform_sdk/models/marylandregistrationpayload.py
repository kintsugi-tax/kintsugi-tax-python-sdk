...
MarylandRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MarylandRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MarylandRegistrationPayloadAmountFees = TypeAliasType(
    "MarylandRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MarylandRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Maryland registration import."""
    ...
    jurisdiction_specific_fields: MarylandFieldsTypedDict
    ...
    amount_fees: NotRequired[MarylandRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MarylandRegistrationPayload(BaseModel):
    r"""Full payload for Maryland registration import."""
    ...
    jurisdiction_specific_fields: MarylandFields
    r"""State-specific fields for Maryland Tax Connect registration import."""
    ...
    amount_fees: Optional[MarylandRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MarylandRegistrationPayload.model_rebuild()
except NameError:
    pass
