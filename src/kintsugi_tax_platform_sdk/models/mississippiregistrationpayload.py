...
MississippiRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MississippiRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MississippiRegistrationPayloadAmountFees = TypeAliasType(
    "MississippiRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MississippiRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Mississippi registration import."""
    ...
    jurisdiction_specific_fields: MississippiFieldsTypedDict
    ...
    amount_fees: NotRequired[MississippiRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MississippiRegistrationPayload(BaseModel):
    r"""Full payload for Mississippi registration import."""
    ...
    jurisdiction_specific_fields: MississippiFields
    r"""State-specific fields for Mississippi TAP portal registration import."""
    ...
    amount_fees: Optional[MississippiRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MississippiRegistrationPayload.model_rebuild()
except NameError:
    pass
