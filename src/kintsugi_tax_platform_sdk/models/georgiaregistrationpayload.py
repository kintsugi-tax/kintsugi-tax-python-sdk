...
GeorgiaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "GeorgiaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


GeorgiaRegistrationPayloadAmountFees = TypeAliasType(
    "GeorgiaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class GeorgiaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Georgia GTC registration import"""
    ...
    jurisdiction_specific_fields: GeorgiaFieldsTypedDict
    ...
    amount_fees: NotRequired[GeorgiaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class GeorgiaRegistrationPayload(BaseModel):
    r"""Full payload for Georgia GTC registration import"""
    ...
    jurisdiction_specific_fields: GeorgiaFields
    r"""State-specific fields for Georgia GTC registration import."""
    ...
    amount_fees: Optional[GeorgiaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    GeorgiaRegistrationPayload.model_rebuild()
except NameError:
    pass
