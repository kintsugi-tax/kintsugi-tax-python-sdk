...
class BackendSrcExemptionsSchemasExemptionExemptionReadTypedDict(TypedDict):
...
class BackendSrcExemptionsSchemasExemptionExemptionRead(BaseModel):
    exemption_type: ExemptionType
...
try:
    BackendSrcExemptionsSchemasExemptionExemptionRead.model_rebuild()
except NameError:
    pass
