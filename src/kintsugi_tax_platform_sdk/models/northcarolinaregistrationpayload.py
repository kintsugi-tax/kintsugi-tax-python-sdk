...
NorthCarolinaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NorthCarolinaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NorthCarolinaRegistrationPayloadAmountFees = TypeAliasType(
    "NorthCarolinaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NorthCarolinaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for North Carolina registration import."""
    ...
    jurisdiction_specific_fields: NorthCarolinaFieldsTypedDict
    ...
    amount_fees: NotRequired[NorthCarolinaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class NorthCarolinaRegistrationPayload(BaseModel):
    r"""Full payload for North Carolina registration import."""
    ...
    jurisdiction_specific_fields: NorthCarolinaFields
    r"""State-specific fields for North Carolina (NCDOR) registration import.
    ...
    amount_fees: Optional[NorthCarolinaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NorthCarolinaRegistrationPayload.model_rebuild()
except NameError:
    pass
