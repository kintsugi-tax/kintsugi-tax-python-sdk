...
SouthDakotaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "SouthDakotaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


SouthDakotaRegistrationPayloadAmountFees = TypeAliasType(
    "SouthDakotaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class SouthDakotaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for South Dakota registration import."""
    ...
    jurisdiction_specific_fields: SouthDakotaFieldsTypedDict
    ...
    amount_fees: NotRequired[SouthDakotaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class SouthDakotaRegistrationPayload(BaseModel):
    r"""Full payload for South Dakota registration import."""
    ...
    jurisdiction_specific_fields: SouthDakotaFields
    r"""State-specific fields for South Dakota (EPath) registration import.
    ...
    amount_fees: Optional[SouthDakotaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    SouthDakotaRegistrationPayload.model_rebuild()
except NameError:
    pass
