...
KentuckyRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "KentuckyRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


KentuckyRegistrationPayloadAmountFees = TypeAliasType(
    "KentuckyRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class KentuckyRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Kentucky registration import."""
    ...
    jurisdiction_specific_fields: KentuckyFieldsTypedDict
    ...
    amount_fees: NotRequired[KentuckyRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class KentuckyRegistrationPayload(BaseModel):
    r"""Full payload for Kentucky registration import."""
    ...
    jurisdiction_specific_fields: KentuckyFields
    r"""State-specific fields for Kentucky KYDOR (MyTaxes) portal registration import."""
    ...
    amount_fees: Optional[KentuckyRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    KentuckyRegistrationPayload.model_rebuild()
except NameError:
    pass
