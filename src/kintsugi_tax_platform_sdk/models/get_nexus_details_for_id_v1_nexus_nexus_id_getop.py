...
class GetNexusDetailsForIDV1NexusNexusIDGetRequestTypedDict(TypedDict):
    nexus_id: str
    r"""The unique identifier of the nexus."""
    x_organization_id: Nullable[str]
    r"""The unique identifier for the organization making the request"""


class GetNexusDetailsForIDV1NexusNexusIDGetRequest(BaseModel):
    nexus_id: Annotated[
