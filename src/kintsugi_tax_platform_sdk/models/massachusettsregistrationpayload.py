...
MassachusettsRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MassachusettsRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MassachusettsRegistrationPayloadAmountFees = TypeAliasType(
    "MassachusettsRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MassachusettsRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Massachusetts registration import."""
    ...
    jurisdiction_specific_fields: MassachusettsFieldsTypedDict
    r"""State-specific fields for Massachusetts registration import (MassTaxConnect)."""
    ...
    amount_fees: NotRequired[MassachusettsRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MassachusettsRegistrationPayload(BaseModel):
    r"""Full payload for Massachusetts registration import."""
    ...
    jurisdiction_specific_fields: MassachusettsFields
    r"""State-specific fields for Massachusetts registration import (MassTaxConnect)."""
    ...
    amount_fees: Optional[MassachusettsRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MassachusettsRegistrationPayload.model_rebuild()
except NameError:
    pass
