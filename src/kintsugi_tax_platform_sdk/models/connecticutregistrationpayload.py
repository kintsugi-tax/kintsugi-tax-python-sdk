...
ConnecticutRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "ConnecticutRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


ConnecticutRegistrationPayloadAmountFees = TypeAliasType(
    "ConnecticutRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class ConnecticutRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Connecticut registration import."""
    ...
    jurisdiction_specific_fields: ConnecticutFieldsTypedDict
    ...
    amount_fees: NotRequired[ConnecticutRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class ConnecticutRegistrationPayload(BaseModel):
    r"""Full payload for Connecticut registration import."""
    ...
    jurisdiction_specific_fields: ConnecticutFields
    r"""State-specific fields for Connecticut registration import (myconneCT / DRS)."""
    ...
    amount_fees: Optional[ConnecticutRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    ConnecticutRegistrationPayload.model_rebuild()
except NameError:
    pass
