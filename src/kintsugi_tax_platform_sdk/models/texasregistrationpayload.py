...
TexasRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "TexasRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


TexasRegistrationPayloadAmountFees = TypeAliasType(
    "TexasRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class TexasRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Texas registration import."""
    ...
    jurisdiction_specific_fields: TexasFieldsTypedDict
    ...
    amount_fees: NotRequired[TexasRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class TexasRegistrationPayload(BaseModel):
    r"""Full payload for Texas registration import."""
    ...
    jurisdiction_specific_fields: TexasFields
    r"""State-specific fields for Texas Comptroller sales tax registration import (Webfile)."""
    ...
    amount_fees: Optional[TexasRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    TexasRegistrationPayload.model_rebuild()
except NameError:
    pass
