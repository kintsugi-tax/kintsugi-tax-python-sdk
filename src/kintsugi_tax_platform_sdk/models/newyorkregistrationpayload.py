...
NewYorkRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NewYorkRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NewYorkRegistrationPayloadAmountFees = TypeAliasType(
    "NewYorkRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NewYorkRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for New York registration import."""
    ...
    jurisdiction_specific_fields: NewYorkFieldsTypedDict
    ...
    amount_fees: NotRequired[NewYorkRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class NewYorkRegistrationPayload(BaseModel):
    r"""Full payload for New York registration import."""
    ...
    jurisdiction_specific_fields: NewYorkFields
    r"""State-specific fields for New York (NYS Tax) registration import.
    ...
    amount_fees: Optional[NewYorkRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NewYorkRegistrationPayload.model_rebuild()
except NameError:
    pass
