...
MichiganRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MichiganRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MichiganRegistrationPayloadAmountFees = TypeAliasType(
    "MichiganRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MichiganRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Michigan registration import."""
    ...
    jurisdiction_specific_fields: MichiganFieldsTypedDict
    ...
    amount_fees: NotRequired[MichiganRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MichiganRegistrationPayload(BaseModel):
    r"""Full payload for Michigan registration import."""
    ...
    jurisdiction_specific_fields: MichiganFields
    r"""State-specific fields for Michigan registration import (Michigan Treasury Online / MTO)."""
    ...
    amount_fees: Optional[MichiganRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MichiganRegistrationPayload.model_rebuild()
except NameError:
    pass
