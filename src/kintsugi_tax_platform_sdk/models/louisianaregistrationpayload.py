...
from .louisianafields import LouisianaFields, LouisianaFieldsTypedDict
...
LouisianaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "LouisianaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


LouisianaRegistrationPayloadAmountFees = TypeAliasType(
    "LouisianaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class LouisianaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Louisiana registration import."""
    ...
    jurisdiction_specific_fields: LouisianaFieldsTypedDict
    ...
    amount_fees: NotRequired[LouisianaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class LouisianaRegistrationPayload(BaseModel):
    r"""Full payload for Louisiana registration import."""
    ...
    amount_fees: Optional[LouisianaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    LouisianaRegistrationPayload.model_rebuild()
except NameError:
    pass
