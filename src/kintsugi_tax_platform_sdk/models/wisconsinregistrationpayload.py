...
WisconsinRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "WisconsinRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


WisconsinRegistrationPayloadAmountFees = TypeAliasType(
    "WisconsinRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class WisconsinRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Wisconsin registration import."""
    ...
    jurisdiction_specific_fields: WisconsinFieldsTypedDict
    ...
    amount_fees: NotRequired[WisconsinRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class WisconsinRegistrationPayload(BaseModel):
    r"""Full payload for Wisconsin registration import."""
    ...
    jurisdiction_specific_fields: WisconsinFields
    r"""State-specific fields for Wisconsin MyTaxAccount portal registration import."""
    ...
    amount_fees: Optional[WisconsinRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    WisconsinRegistrationPayload.model_rebuild()
except NameError:
    pass
