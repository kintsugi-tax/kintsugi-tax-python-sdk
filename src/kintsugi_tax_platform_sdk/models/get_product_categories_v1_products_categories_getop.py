...
from kintsugi_tax_platform_sdk.utils import FieldMetadata, HeaderMetadata
import pydantic
from pydantic import model_serializer
from typing_extensions import Annotated, TypedDict


class GetProductCategoriesV1ProductsCategoriesGetRequestTypedDict(TypedDict):
    x_organization_id: Nullable[str]
    r"""The unique identifier for the organization making the request"""


class GetProductCategoriesV1ProductsCategoriesGetRequest(BaseModel):
