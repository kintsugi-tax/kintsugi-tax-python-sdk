...
MaineRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "MaineRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


MaineRegistrationPayloadAmountFees = TypeAliasType(
    "MaineRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class MaineRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Maine registration import."""
    ...
    jurisdiction_specific_fields: MaineFieldsTypedDict
    r"""State-specific fields for Maine Tax Portal registration import."""
    ...
    amount_fees: NotRequired[MaineRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class MaineRegistrationPayload(BaseModel):
    r"""Full payload for Maine registration import."""
    ...
    jurisdiction_specific_fields: MaineFields
    r"""State-specific fields for Maine Tax Portal registration import."""
    ...
    amount_fees: Optional[MaineRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    MaineRegistrationPayload.model_rebuild()
except NameError:
    pass
