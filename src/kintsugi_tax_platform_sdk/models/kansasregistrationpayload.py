...
KansasRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "KansasRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


KansasRegistrationPayloadAmountFees = TypeAliasType(
    "KansasRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class KansasRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Kansas registration import."""
    ...
    jurisdiction_specific_fields: KansasFieldsTypedDict
    ...
    amount_fees: NotRequired[KansasRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class KansasRegistrationPayload(BaseModel):
    r"""Full payload for Kansas registration import."""
    ...
    amount_fees: Optional[KansasRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    KansasRegistrationPayload.model_rebuild()
except NameError:
    pass
