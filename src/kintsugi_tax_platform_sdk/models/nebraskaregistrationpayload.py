...
NebraskaRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NebraskaRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NebraskaRegistrationPayloadAmountFees = TypeAliasType(
    "NebraskaRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NebraskaRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for a Nebraska registration import."""
    ...
    jurisdiction_specific_fields: NebraskaFieldsTypedDict
    ...
    amount_fees: NotRequired[NebraskaRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
    ...
    r"""Five-digit Nebraska PIN shown with the User ID on Form 10. Encrypted into pin_encrypted on save."""


class NebraskaRegistrationPayload(BaseModel):
    r"""Full payload for a Nebraska registration import."""
    ...
    jurisdiction_specific_fields: NebraskaFields
    r"""State-specific fields for a Nebraska registration import."""
    ...
    amount_fees: Optional[NebraskaRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NebraskaRegistrationPayload.model_rebuild()
except NameError:
    pass
