...
IdahoRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "IdahoRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


IdahoRegistrationPayloadAmountFees = TypeAliasType(
    "IdahoRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class IdahoRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Idaho registration import."""
    ...
    jurisdiction_specific_fields: IdahoFieldsTypedDict
    ...
    amount_fees: NotRequired[IdahoRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class IdahoRegistrationPayload(BaseModel):
    r"""Full payload for Idaho registration import."""
    ...
    jurisdiction_specific_fields: IdahoFields
    r"""State-specific fields for Idaho TAP portal registration import."""
    ...
    amount_fees: Optional[IdahoRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    IdahoRegistrationPayload.model_rebuild()
except NameError:
    pass
