...
VermontRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "VermontRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


VermontRegistrationPayloadAmountFees = TypeAliasType(
    "VermontRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class VermontRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Vermont registration import."""
    ...
    jurisdiction_specific_fields: VermontFieldsTypedDict
    ...
    amount_fees: NotRequired[VermontRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class VermontRegistrationPayload(BaseModel):
    r"""Full payload for Vermont registration import."""
    ...
    jurisdiction_specific_fields: VermontFields
    r"""State-specific fields for Vermont myVTax portal registration import."""
    ...
    amount_fees: Optional[VermontRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    VermontRegistrationPayload.model_rebuild()
except NameError:
    pass
