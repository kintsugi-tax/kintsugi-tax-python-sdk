...
class CreateProductV1ProductsPostRequestTypedDict(TypedDict):
    x_organization_id: Nullable[str]
    r"""The unique identifier for the organization making the request"""
    product_create_manual: ProductCreateManualTypedDict


class CreateProductV1ProductsPostRequest(BaseModel):
    ...
    product_create_manual: Annotated[
        ProductCreateManual,
