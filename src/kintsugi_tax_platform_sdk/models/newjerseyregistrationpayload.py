...
NewJerseyRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "NewJerseyRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


NewJerseyRegistrationPayloadAmountFees = TypeAliasType(
    "NewJerseyRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class NewJerseyRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for New Jersey registration import."""
    ...
    jurisdiction_specific_fields: NewJerseyFieldsTypedDict
    ...
    amount_fees: NotRequired[NewJerseyRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class NewJerseyRegistrationPayload(BaseModel):
    r"""Full payload for New Jersey registration import."""
    ...
    jurisdiction_specific_fields: NewJerseyFields
    r"""State-specific fields for New Jersey (Premier Business Services) registration import.
    ...
    amount_fees: Optional[NewJerseyRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    NewJerseyRegistrationPayload.model_rebuild()
except NameError:
    pass
