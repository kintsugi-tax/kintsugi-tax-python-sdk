...
RhodeIslandRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "RhodeIslandRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


RhodeIslandRegistrationPayloadAmountFees = TypeAliasType(
    "RhodeIslandRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class RhodeIslandRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Rhode Island registration import."""
    ...
    jurisdiction_specific_fields: RhodeIslandFieldsTypedDict
    ...
    amount_fees: NotRequired[RhodeIslandRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class RhodeIslandRegistrationPayload(BaseModel):
    r"""Full payload for Rhode Island registration import."""
    ...
    jurisdiction_specific_fields: RhodeIslandFields
    r"""State-specific fields for Rhode Island Taxpayer Portal registration import."""
    ...
    amount_fees: Optional[RhodeIslandRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    RhodeIslandRegistrationPayload.model_rebuild()
except NameError:
    pass
