...
IllinoisRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "IllinoisRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


IllinoisRegistrationPayloadAmountFees = TypeAliasType(
    "IllinoisRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class IllinoisRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Illinois registration import."""
    ...
    jurisdiction_specific_fields: IllinoisFieldsTypedDict
    ...
    amount_fees: NotRequired[IllinoisRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class IllinoisRegistrationPayload(BaseModel):
    r"""Full payload for Illinois registration import."""
    ...
    jurisdiction_specific_fields: IllinoisFields
    r"""State-specific fields for Illinois registration import (MyTax Illinois)."""
    ...
    amount_fees: Optional[IllinoisRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    IllinoisRegistrationPayload.model_rebuild()
except NameError:
    pass
