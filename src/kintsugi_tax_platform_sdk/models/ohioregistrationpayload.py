...
OhioRegistrationPayloadAmountFeesTypedDict = TypeAliasType(
    "OhioRegistrationPayloadAmountFeesTypedDict", Union[float, str]
)
r"""The amount of fees associated with the registration."""


OhioRegistrationPayloadAmountFees = TypeAliasType(
    "OhioRegistrationPayloadAmountFees", Union[float, str]
)
r"""The amount of fees associated with the registration."""


class OhioRegistrationPayloadTypedDict(TypedDict):
    r"""Full payload for Ohio registration import."""
    ...
    jurisdiction_specific_fields: OhioFieldsTypedDict
    ...
    amount_fees: NotRequired[OhioRegistrationPayloadAmountFeesTypedDict]
    r"""The amount of fees associated with the registration."""
...
class OhioRegistrationPayload(BaseModel):
    r"""Full payload for Ohio registration import."""
    ...
    jurisdiction_specific_fields: OhioFields
    r"""State-specific fields for Ohio OH|TAX eServices registration import."""
    ...
    amount_fees: Optional[OhioRegistrationPayloadAmountFees] = None
    r"""The amount of fees associated with the registration."""
...
try:
    OhioRegistrationPayload.model_rebuild()
except NameError:
    pass
