...
class Customers(BaseSDK):
    def list(
        ...
        *,
        ...
        country: OptionalNullable[
            Union[
                Iterable[models.GetCustomersV1Country],
                Iterable[models.GetCustomersV1CountryTypedDict],
            ]
        ] = UNSET,
        ...
        :param connection_id_in: Filter customers by connection ID (comma-separated)
        ...
        request = models.GetCustomersV1Request(
            ...
            country=utils.unmarshal(
                country, OptionalNullable[List[models.GetCustomersV1Country]]
            ),
            state=state,
            source_in=source_in,
    ...
    def create(
        ...
        *,
        ...
        :param company_name: Registered or legal business name of the customer.
    ...
    def get_transactions(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ResponseGetTransactionsByCustomerIDV1CustomersCustomerIDTransactionsGet:
    ...
    def create_transaction(
        ...
        *,
        ...
        converted_total_amount: OptionalNullable[
            Union[models.ConvertedTotalAmount, models.ConvertedTotalAmountTypedDict]
        ] = UNSET,
        converted_total_tax_amount_imported: OptionalNullable[
            Union[
                models.ConvertedTotalTaxAmountImported,
                models.ConvertedTotalTaxAmountImportedTypedDict,
            ]
        ] = UNSET,
        converted_total_tax_amount_calculated: OptionalNullable[
            Union[
                models.ConvertedTotalTaxAmountCalculated,
                models.ConvertedTotalTaxAmountCalculatedTypedDict,
            ]
        ] = UNSET,
        conversion_rate: OptionalNullable[
            Union[models.ConversionRate, models.ConversionRateTypedDict]
        ] = UNSET,
        ...
        converted_total_tax_liability_amount: OptionalNullable[
            Union[
                models.ConvertedTotalTaxLiabilityAmount,
                models.ConvertedTotalTaxLiabilityAmountTypedDict,
            ]
        ] = UNSET,
